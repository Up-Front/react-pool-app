...
export const WinnerWarningWrapper = styled.div`
    position: absolute;
    display: flex;
    align-items: center;
...
export const BoomText = styled(BoomTextBase) `
    background: linear-gradient(to bottom, #e8bf2e 0%,#e58500 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
